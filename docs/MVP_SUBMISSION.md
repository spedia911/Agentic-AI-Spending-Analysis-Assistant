...
For paste-ready Kaggle assets, see [KAGGLE_WRITEUP_DRAFT.md](submission/KAGGLE_WRITEUP_DRAFT.md), [ARCHITECTURE_AND_RUBRIC.md](submission/ARCHITECTURE_AND_RUBRIC.md), [COURSE_CONCEPT_COVERAGE.md](submission/COURSE_CONCEPT_COVERAGE.md), [VIDEO_SCRIPT.md](submission/VIDEO_SCRIPT.md), and [MEDIA_GALLERY_PLAN.md](submission/MEDIA_GALLERY_PLAN.md).
